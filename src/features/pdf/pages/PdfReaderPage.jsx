            ...
            <div className="reader-columns">
                ...
                <article className="reader-card reader-preview-card">
                    <header className="reader-preview-heading">
                        ...
                        <span className={`reader-status ${preview ? "ready" : ""}`}><Icon name={preview ? "check" : "file"} size={21} />{preview ? "Listo para visualizar" : "Esperando documento"}</span>
                    </header>

                    {preview ? (
                        <iframe src={preview} title="Vista previa del PDF" />
                    ) : (
                        <div className="reader-empty-preview">
                            <span className="reader-empty-icon"><Icon name="file" size={58} /></span>
                            <h3>Tu PDF aparecerá aquí</h3>
                            <p>Pega un código Base64 o sube un archivo PDF para comenzar.</p>
                        </div>
                    )}
                </article>
            </div>
